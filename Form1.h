...
namespace CLR_SimulateurVoiture {
	...
	private: System::Windows::Forms::Label^ txtNbConsgienTemperature;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtNbConsgienTemperature = (gcnew System::Windows::Forms::Label());
			...
			groupBox5->Controls->Add(this->txtNbConsgienTemperature);
			...
			// 
			// txtNbConsgienTemperature
			// 
			this->txtNbConsgienTemperature->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->txtNbConsgienTemperature->Location = System::Drawing::Point(161, 90);
			this->txtNbConsgienTemperature->Name = L"txtNbConsgienTemperature";
			this->txtNbConsgienTemperature->Size = System::Drawing::Size(144, 20);
			this->txtNbConsgienTemperature->TabIndex = 7;
			this->txtNbConsgienTemperature->Text = L"0";
			this->txtNbConsgienTemperature->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			// 
			// txtNbVitesse
			// 
			...
			this->btnPharePositions->TabStop = true;
			...
			this->btnPhareCroisements->TabStop = true;
			...
			this->btnPhareRoutes->TabStop = true;
			...
			this->btnVitresDescendre->TabStop = true;
			...
			this->btnVitresMonter->TabStop = true;
			...
			this->btnClimAllumer->TabStop = true;
			...
			this->btnChauffageAllumer->TabStop = true;
			...
			this->btnFreinAppuyer->TabStop = true;
			...
			this->btnAccAppuyer->TabStop = true;
